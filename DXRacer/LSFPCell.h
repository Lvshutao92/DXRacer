...
@interface LSFPCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *juli1;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *juli2;


@property (weak, nonatomic) IBOutlet NSLayoutConstraint *height2;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *julis1;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *julis2;
