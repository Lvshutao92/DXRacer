...
@interface clothescolorListModel : NSObject
@property (nonatomic , strong) NSString              * chair_color_code;
@property (nonatomic , strong) NSString              * chair_color_name;
@property (nonatomic , strong) NSString              * chair_logo_code;
@property (nonatomic , strong) NSString              * chair_logo_name;
@property (nonatomic , strong) NSString              * clothes_color_code;
@property (nonatomic , strong) NSString              * clothes_color_name;
@property (nonatomic , strong) NSString              * clothes_size_code;
